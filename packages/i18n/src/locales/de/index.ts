...
export const de = {
  ...
  "nav": {
    ...
    batchArchive: "{{count}} Sitzungen archivieren",
...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    sendNowPending: "Warten auf das Ende der aktuellen Aufgabe",
    queuedPromptStopFailed: "Die aktuelle Aufgabe konnte nicht gestoppt werden. Diese Nachricht wartet noch und kann abgebrochen werden.",
    queuedPromptAlreadyStarted: "Diese Nachricht wird bereits ausgeführt. Verwenden Sie Stopp, um die laufende Aufgabe zu stoppen.",
  ...
  "settings": {
    ...
    "downloadGeneratedImage": "Herunterladen",
    "revealGeneratedImage": "Im Ordner anzeigen",
    "imageRevealFailed": "Das Bild konnte nicht im Ordner angezeigt werden.",
...
sklm: {
    ...
    "voiceChineseVariant": "Chinesische Variante",
    "voiceSimplified": "Vereinfacht",
    "voiceTraditionalTaiwan": "Traditionell (Taiwan)",
    "voiceTraditionalHK": "Traditionell (Hongkong)",
    "voiceModel": "Transkriptionsmodell",
    "voiceModelDownload": "Herunterladen",
    "voiceModelDelete": "Löschen",
    "voiceModelDownloaded": "Heruntergeladen",
    "voiceModelDownloading": "Wird heruntergeladen…",
    "voiceModelNotDownloaded": "Nicht heruntergeladen",
    "voiceModelSize": "{{size}}",
    "voiceShortcut": "Tastenkürzel",
    "voiceLocalModels": "Lokale Modelle",
    "voiceNoModelSelected": "Kein Modell ausgewählt",
    "voiceSelectModel": "Wählen Sie ein Modell aus",
    "voiceMicDenied": "Mikrofonzugriff verweigert",
    "voiceMicDeniedDesc": "Gewähren Sie den Mikrofonzugriff in den Systemeinstellungen.",
    "voiceMicUnavailable": "Mikrofon nicht verfügbar",
    "voiceOpenSystemSettings": "Systemeinstellungen öffnen",
    "voiceRecording": "Aufnahme…",
    "voiceTranscribing": "Transkription…",
    ...
    "preventScreenSleepDesc": "Hält das Display wach, solange die App läuft. Nutzt plattformübergreifend die System-Energieverwaltung.",
    ...
    endpointFormatGuidance: "Diese Anfrage-URL deutet auf {{format}} hin. Übernehmen Sie Format und Basisadresse; dies prüft weder die Verbindung noch die Suchfunktion.",
    applyEndpointFormat: "Vorgeschlagenes Format übernehmen",
    ...
    nativeWebSearchUnsupported: "Diese Verbindung unterstützt in der App noch keine native Suche. Die Website oder eine andere API kann Suche anbieten.",
    ...
    "midAutumnEgg": "Mondfest-Osterei",
    "midAutumnEggDesc": "Eine bildschirmfüllende Mondfest-Animation, die beim Start der App einmal abgespielt wird; hier können Sie sie erneut abspielen.",
    "playMidAutumnEgg": "Abspielen",
    "closeEasterEgg": "Schließen",
  ...
  "plugins": {
    ...
    piSkillsTitle: "Skills aus pi CLI",
    piSkillsHint: "Installierte npm-Pakete werden nur gelesen. Importieren Sie nur vertrauenswürdige Pakete; verwalten Sie sie anschließend unter Plugins.",
    piSkillsConfirm: "Dieses pi-Paket importieren und aktivieren?",
    piSkillsExecutable: "Dieses Paket enthält ausführbare Erweiterungen. Der Import aktiviert vertrauenswürdigen Code im Agenten und installiert möglicherweise Abhängigkeiten.",
    piSkillsPromptOnly: "Dieses Paket fügt dem Agenten Anweisungen hinzu. Ressourcen werden kopiert; deklarierte Abhängigkeiten werden gegebenenfalls installiert.",
    piSkillsImport: "Importieren und aktivieren",
    piSkillsImported: "Bereits importiert",
    piSkillsRefresh: "pi-CLI-Skills aktualisieren",
    piSkillsEmpty: "Keine pi-CLI-npm-Skill-Pakete gefunden.",
    piSkillsLoading: "pi-CLI-Skills werden gesucht…",
