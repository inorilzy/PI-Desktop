...
export const de = {
  ...
  "chat": {
    ...
    "transcribeFailed": "Dieses Audio konnte nicht transkribiert werden",
    "speak": "Vorlesen",
    "speaking": "Wird vorgelesen…",
    "speakFailed": "Dieser Entwurf konnte nicht vorgelesen werden",
...
sklm: {
    ...
    "speechTitle": "Stimme",
    "speechDesc": "Transkription und Sprache nutzen einen konfigurierten Anbieter und erscheinen nicht in der Chat-Modellliste.",
    "speechTranscribe": "Transkription",
    "speechTranscribeDesc": "Angehängtes Audio in Entwurftext verwandeln.",
    "speechSynthesize": "Sprache",
    "speechSynthesizeDesc": "Den Composer-Entwurf vorlesen.",
    "speechProvider": "Anbieter",
    "speechProtocol": "Protokoll",
    "speechModel": "Modell",
    "speechVoice": "Stimme",
    "speechNone": "Nicht konfiguriert",
...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
     ...
     */
    trustTier: {
      renderer: "Läuft im App-Fenster",
      rendererHelp: "Es zeichnet im Fenster der App selbst und teilt sich damit deren Prozess.",
