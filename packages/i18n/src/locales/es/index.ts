...
export const es = {
  ...
  "nav": {
    ...
    batchArchive: "Archivar {{count}} sesiones",
...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    sendNowPending: "Esperando a que termine la tarea actual",
    queuedPromptStopFailed: "No se pudo detener la tarea actual. Este mensaje sigue en cola y se puede cancelar.",
    queuedPromptAlreadyStarted: "Este mensaje ya se está ejecutando. Usa Detener para detener la tarea actual.",
  ...
  "settings": {
    ...
    "downloadGeneratedImage": "Descargar",
    "revealGeneratedImage": "Mostrar en carpeta",
    "imageRevealFailed": "No se pudo mostrar la imagen en su carpeta.",
...
sklm: {
    ...
    "voiceChineseVariant": "Variante china",
    "voiceSimplified": "Simplificado",
    "voiceTraditionalTaiwan": "Tradicional (Taiwán)",
    "voiceTraditionalHK": "Tradicional (Hong Kong)",
    "voiceModel": "Modelo de transcripción",
    "voiceModelDownload": "Descargar",
    "voiceModelDelete": "Eliminar",
    "voiceModelDownloaded": "Descargado",
    "voiceModelDownloading": "Descargando…",
    "voiceModelNotDownloaded": "No descargado",
    "voiceModelSize": "{{size}}",
    "voiceShortcut": "Atajo",
    "voiceLocalModels": "Modelos locales",
    "voiceNoModelSelected": "Ningún modelo seleccionado",
    "voiceSelectModel": "Seleccione un modelo para comenzar",
    "voiceMicDenied": "Acceso al micrófono denegado",
    "voiceMicDeniedDesc": "Conceda acceso al micrófono en la configuración del sistema.",
    "voiceMicUnavailable": "Micrófono no disponible",
    "voiceOpenSystemSettings": "Abrir configuración del sistema",
    ...
    "preventScreenSleepDesc": "Mantiene la pantalla encendida mientras la aplicación está en ejecución. Usa las API de gestión de energía del sistema en todas las plataformas.",
    ...
    endpointFormatGuidance: "Esta URL de solicitud indica {{format}}. Aplica el formato y la dirección base correspondientes; esto no verifica la conexión ni la capacidad de búsqueda.",
    ...
    nativeWebSearchUnsupported: "La aplicación aún no integra búsqueda nativa para esta conexión. El sitio web u otra API pueden ofrecerla.",
    ...
    "midAutumnEgg": "Huevo del Festival del Medio Otoño",
    "midAutumnEggDesc": "Una animación a pantalla completa del Festival del Medio Otoño que se reproduce una vez al abrir la aplicación; puedes volver a reproducirla aquí.",
    "playMidAutumnEgg": "Reproducir",
    "closeEasterEgg": "Cerrar",
