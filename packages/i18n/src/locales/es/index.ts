...
export const es = {
  ...
  "chat": {
    ...
    "transcribeFailed": "No se pudo transcribir este audio",
    "speak": "Leer en voz alta",
    "speaking": "Leyendo…",
    "speakFailed": "No se pudo leer este borrador",
    ...
    "rewrittenByPlugin": "Reescrito por {{name}}",
    "rewriteModelVersion": "Lo que recibió el modelo",
    "rewritePartial":
      "El registro se recortó, así que parte del cambio no se muestra.",
...
sklm: {
    ...
    "thinkingDisplayModeDesc": "Detallado muestra el razonamiento. Compacto muestra un indicador mientras se razona y oculta el razonamiento al terminar.",
    ...
    "speechTitle": "Voz",
    "speechDesc": "La transcripción y la voz usan un proveedor configurado. No aparecen en el selector de modelos del chat.",
    "speechTranscribe": "Transcripción",
    "speechTranscribeDesc": "Convertir el audio adjunto en texto del borrador.",
    "speechSynthesize": "Voz",
    "speechSynthesizeDesc": "Leer en voz alta el borrador del compositor.",
    "speechProvider": "Proveedor",
    "speechProtocol": "Protocolo",
    "speechModel": "Modelo",
    "speechVoice": "Voz",
    "speechNone": "Sin configurar",
