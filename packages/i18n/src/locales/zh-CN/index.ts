...
export const zhCN = {
  ...
  chat: {
    ...
    transcribe: "转写音频",
    transcribing: "转写中…",
    transcribeFailed: "无法转写这段音频",
    speak: "朗读",
    speaking: "朗读中…",
    speakFailed: "无法朗读这段草稿",
    ...
    rewrittenByPlugin: "已由 {{name}} 改写",
    rewriteModelVersion: "模型实际收到的内容",
    rewritePartial: "记录已截断，部分改动未显示。",
...
sklm: {
    ...
    remoteHosts: {
      title: "远程主机",
      overview:
        "已配对的 pi-host 机器；桌面能像本地一样驱动其上的会话，连接留在主进程内，设备令牌不会到达此页面。",
      listTitle: "已配对的远程主机",
      listError: "加载主机列表失败",
      loading: "加载中…",
      emptyTitle: "还没有配对主机",
      emptyBody: "在下方配对一台机器以开始远程会话。",
      statusOnline: "在线",
      statusOffline: "离线",
      remove: "移除",
      removing: "移除中…",
      ...
      fieldLabel: "标签",
      fieldLabelDesc: "在列表中显示，也记录到已配对主机上。",
      fieldLabelPlaceholder: "家里的 Linux",
      fieldUrl: "RACP 地址",
      fieldUrlDesc:
        "pi-host 的回环端点，例如 ws://127.0.0.1:9443/racp（经 SSH 转发）。",
      fieldPairingToken: "配对令牌",
      fieldPairingTokenDesc:
        "来自 pi-host 引导输出的一次性 ppt1.* 令牌，配对后即消耗。",
    },
    importTitle: "从其他工具导入",
    importScan: "扫描",
    importScanning: "正在扫描…",
    ...
    defaultsTitle: "默认项",
    speechTitle: "语音",
    speechDesc: "转写和朗读使用已配置的服务，不会出现在聊天模型列表里。",
    speechTranscribe: "转写",
    speechTranscribeDesc: "把附件音频转成草稿文字。",
    speechSynthesize: "朗读",
    speechSynthesizeDesc: "朗读输入框里的草稿。",
    speechProvider: "服务",
    speechProtocol: "协议",
    speechModel: "模型",
    speechVoice: "音色",
