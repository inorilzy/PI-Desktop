...
export const zhCN = {
  ...
  nav: {
    ...
    batchArchive: "归档 {{count}} 个会话",
    batchDelete: "删除 {{count}} 个会话",
    batchDeleteConfirm: "确认删除 {{count}} 个会话？",
  ...
  chat: {
    ...
    sendNow: "立即发送",
    sendNowPending: "等待当前任务结束",
    queuedPromptStopFailed: "未能停止当前任务。这条消息仍在排队，可以取消。",
    queuedPromptAlreadyStarted: "这条消息已经开始执行，请使用停止按钮。",
  ...
  settings: {
    ...
    downloadGeneratedImage: "下载",
    revealGeneratedImage: "在文件夹中显示",
    imageRevealFailed: "无法在文件夹中显示图片。",
...
sklm: {
    ...
    voiceLanguages: "语言",
    voiceChineseVariant: "中文变体",
    voiceSimplified: "简体",
    voiceTraditionalTaiwan: "繁体（台湾）",
    voiceTraditionalHK: "繁体（香港）",
    voiceModel: "转写模型",
    voiceModelDownload: "下载",
    voiceModelDelete: "删除",
    voiceModelDownloaded: "已下载",
    voiceModelDownloading: "下载中…",
    voiceModelNotDownloaded: "未下载",
    voiceModelSize: "{{size}}",
    voiceShortcut: "快捷键",
    voiceLocalModels: "本地模型",
    voiceNoModelSelected: "未选择模型",
    voiceSelectModel: "请选择模型以开始使用",
    voiceMicDenied: "麦克风权限被拒绝",
    voiceMicDeniedDesc: "请在系统设置中授予麦克风访问权限。",
    voiceMicUnavailable: "麦克风不可用",
    voiceOpenSystemSettings: "打开系统设置",
    voiceRecording: "正在录音…",
    ...
    nativeWebSearchUnsupported: "应用尚未适配此连接的原生搜索；不代表厂商官网或其他 API 不支持搜索。",
    ...
    easterEggs: "彩蛋",
    midAutumnEgg: "中秋彩蛋",
    midAutumnEggDesc: "应用启动时播放一次的全屏中秋动画，可在此再次播放。",
  ...
  plugins: {
    ...
    piSkillsHint: "只读发现已安装的 npm 包。请仅导入可信来源；导入后在插件页管理。",
    piSkillsConfirm: "导入并启用这个 pi 包？",
    piSkillsExecutable: "此包包含可执行扩展。导入会在 Agent 中启用可信代码，并可能安装依赖。",
    piSkillsPromptOnly: "此包会向 Agent 添加指令。资源将被复制，并可能安装声明的依赖。",
    piSkillsImport: "导入并启用",
    piSkillsImported: "已导入",
  ...
  extensions: {
    ...
    mcp: {
      ...
      commandHintNpx: "自动查找本机 Node.js，包括 PATH、官方安装、fnm、nvm。",
      commandHintUvx: "自动查找本机的 uv。",
      launcherCustom: "自定义",
      commandPath: "可执行文件",
      commandPlaceholder: "npx 或绝对路径",
      args: "参数",
