...
export const ko = {
  ...
  chat: {
    ...
    transcribe: "오디오 받아쓰기",
    transcribing: "받아쓰는 중…",
    transcribeFailed: "이 오디오를 받아쓸 수 없습니다",
    speak: "소리 내어 읽기",
    speaking: "읽는 중…",
    speakFailed: "이 초안을 읽을 수 없습니다",
    ...
    rewrittenByPlugin: "{{name}}이(가) 다시 작성함",
    rewriteModelVersion: "모델이 받은 내용",
    rewritePartial: "기록이 잘려서 변경 내용의 일부만 표시됩니다.",
...
sklm: {
    ...
    remoteHosts: {
      title: "원격 호스트",
      overview:
        "이 데스크톱에서 조작할 수 있는 페어링된 pi-host 머신입니다. 페어링된 호스트의 세션은 로컬처럼 렌더링되며, 연결은 메인 프로세스에 남고 디바이스 토큰은 이 페이지에 도달하지 않습니다.",
      listTitle: "페어링된 원격 호스트",
      listError: "호스트를 불러오지 못했습니다",
      loading: "로드 중…",
      emptyTitle: "페어링된 호스트가 아직 없습니다",
      emptyBody: "아래에서 머신을 페어링하여 세션을 시작하세요.",
      statusOnline: "온라인",
      statusOffline: "오프라인",
      remove: "제거",
      removing: "제거 중…",
      ...
      fieldLabel: "라벨",
      fieldLabelDesc: "목록에 표시되고 페어링된 호스트에 기록됩니다.",
      fieldLabelPlaceholder: "집 Linux",
      fieldUrl: "RACP URL",
      fieldUrlDesc:
        "pi-host의 루프백 엔드포인트, 예: ws://127.0.0.1:9443/racp (SSH로 포워딩).",
      fieldPairingToken: "페어링 토큰",
      fieldPairingTokenDesc:
        "pi-host 부트스트랩 출력의 일회용 ppt1.* 토큰. 페어링 시 소비됩니다.",
    },
    ...
    defaultsTitle: "기본값",
    speechTitle: "음성",
    speechDesc: "받아쓰기와 낭독은 설정된 제공자를 사용하며 채팅 모델 목록에는 나오지 않습니다.",
    speechTranscribe: "받아쓰기",
    speechTranscribeDesc: "첨부된 오디오를 초안 텍스트로 바꿉니다.",
    speechSynthesize: "낭독",
    speechSynthesizeDesc: "입력창의 초안을 소리 내어 읽습니다.",
    speechProvider: "제공자",
    speechProtocol: "프로토콜",
    speechModel: "모델",
    speechVoice: "목소리",
...
importConfirm: "가져온 확장은 에이전트 프로세스 안에서 에이전트 자체 도구와 같은 권한으로 실행됩니다. 선언된 스킬은 에이전트에 지침을 추가할 수 있고, 선언된 의존성은 npm으로 설치됩니다(설치 스크립트 비활성화). 계속할까요?",
    ...
    permissions: {
      ...
      "runtime.turn.continue": "턴이 끝난 뒤 새 턴 시작",
      "runtime.turn.recap": "턴에 담긴 내용 읽기",
      "runtime.turn.watch": "실행 중인 턴 관찰",
    ...
    permissionHelp: {
      ...
      "runtime.session.read":
        "플러그인은 세션 내용, 즉 사용자와 에이전트가 한 말을 읽을 수 있습니다. 읽기는 건별로 기록되지 않으며, 이 설치 검토가 동의 지점입니다.",
      "runtime.tool.gate":
        "도구 호출 전에 플러그인을 확인해 이유와 함께 호출을 차단할 수 있고, 실행 후에는 도구 결과를 교체할 수 있습니다. 모델이 고른 호출 인자는 바꿀 수 없습니다.",
      "runtime.turn.continue":
        "턴이 끝난 뒤 플러그인은 사용자 메시지 없이 새 턴을 시작할 수 있습니다. 모델 할당량을 더 쓰게 되며, 추가된 턴은 플러그인 출처가 표시된 보이는 행으로 저장됩니다.",
      "runtime.turn.recap":
        "플러그인은 한 턴에 담긴 내용과 그 대화 본문을 읽을 수 있습니다. 한 턴이 아니라 세션 전체를 읽으려면 세션 읽기 권한이 추가로 필요합니다.",
      "runtime.turn.watch":
        "플러그인은 실행 중인 턴의 이벤트(스트리밍 메시지, 도구 실행, 턴과 에이전트 경계)를 받으며 관찰만 할 수 있습니다. 이벤트는 최선형 전달이며 재전송되지 않습니다.",
      "provider.register":
