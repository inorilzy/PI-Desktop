...
export const ko = {
  ...
  nav: {
    ...
    batchArchive: "{{count}}개 세션 보관",
    batchDelete: "{{count}}개 세션 삭제",
    batchDeleteConfirm: "{{count}}개 세션을 삭제하시겠습니까?",
  ...
  chat: {
    ...
    sendNow: "지금 보내기",
    sendNowPending: "현재 작업이 끝나기를 기다리는 중",
    queuedPromptStopFailed: "현재 작업을 중지하지 못했습니다. 이 메시지는 아직 대기 중이며 취소할 수 있습니다.",
    queuedPromptAlreadyStarted: "이 메시지는 이미 실행 중입니다. 중지 버튼을 사용하세요.",
  ...
  settings: {
    ...
    "downloadGeneratedImage": "다운로드",
    "revealGeneratedImage": "폴더에서 보기",
    "imageRevealFailed": "폴더에서 이미지를 표시할 수 없습니다.",
...
sklm: {
    ...
    voiceLanguages: "언어",
    voiceChineseVariant: "중국어 변형",
    voiceSimplified: "간체",
    voiceTraditionalTaiwan: "번체 (대만)",
    voiceTraditionalHK: "번체 (홍콩)",
    voiceModel: "전사 모델",
    voiceModelDownload: "다운로드",
    voiceModelDelete: "삭제",
    voiceModelDownloaded: "다운로드됨",
    voiceModelDownloading: "다운로드 중…",
    voiceModelNotDownloaded: "다운로드되지 않음",
    voiceModelSize: "{{size}}",
    voiceShortcut: "단축키",
    voiceLocalModels: "로컬 모델",
    voiceNoModelSelected: "모델이 선택되지 않음",
    voiceSelectModel: "시작하려면 모델을 선택하세요",
    voiceMicDenied: "마이크 접근 거부됨",
    voiceMicDeniedDesc: "시스템 설정에서 마이크 접근 권한을 허용하세요.",
    voiceMicUnavailable: "마이크를 사용할 수 없음",
    voiceOpenSystemSettings: "시스템 설정 열기",
    voiceRecording: "녹음 중…",
    voiceTranscribing: "전사 중…",
    voiceCancel: "취소",
    shortcutGroup: {
      navigation: "탐색",
      agent: "에이전트",
    ...
    preventScreenSleepDesc: "앱이 실행되는 동안 화면이 꺼지지 않도록 합니다. 모든 플랫폼에서 시스템 전원 관리 API를 사용합니다.",
    ...
    endpointFormatGuidance: "이 요청 URL은 {{format}} 형식을 나타냅니다. 해당 형식과 기본 주소를 적용할 수 있지만 연결이나 검색 기능이 검증된 것은 아닙니다.",
    applyEndpointFormat: "제안된 형식 적용",
    ...
    nativeWebSearchUnsupported: "이 연결의 네이티브 검색은 아직 앱에 통합되지 않았습니다. 웹사이트나 다른 API에서는 검색을 지원할 수 있습니다.",
    ...
    easterEggs: "이스터 에그",
    midAutumnEgg: "추석 이스터 에그",
    midAutumnEggDesc: "앱을 열 때 한 번 재생되는 전체 화면 추석 애니메이션이며, 여기서 다시 재생할 수 있습니다.",
    playMidAutumnEgg: "다시 재생",
    closeEasterEgg: "닫기",
    developer: "개발자",
  ...
  plugins: {
    ...
    piSkillsTitle: "pi CLI 스킬",
    piSkillsHint: "설치된 npm 패키지를 읽기 전용으로 검색합니다. 신뢰하는 패키지만 가져오세요. 가져온 패키지는 플러그인에서 관리합니다.",
    piSkillsConfirm: "이 pi 패키지를 가져와 활성화할까요?",
    piSkillsExecutable: "이 패키지에는 실행 가능한 확장이 포함되어 있습니다. 가져오면 에이전트에서 신뢰된 코드가 활성화되며 종속성이 설치될 수 있습니다.",
    piSkillsPromptOnly: "이 패키지는 에이전트에 지침을 추가합니다. 리소스가 복사되며 선언된 종속성이 설치될 수 있습니다.",
    piSkillsImport: "가져와 활성화",
    piSkillsImported: "이미 가져옴",
    piSkillsRefresh: "pi CLI 스킬 새로고침",
    piSkillsEmpty: "pi CLI npm 스킬 패키지를 찾을 수 없습니다.",
    piSkillsLoading: "pi CLI 스킬 검색 중…",
...
importConfirm: "가져온 확장은 에이전트 프로세스 안에서 에이전트 자체 도구와 같은 권한으로 실행됩니다. 선언된 스킬은 에이전트에 지침을 추가할 수 있고, 선언된 의존성은 npm으로 설치됩니다(설치 스크립트 비활성화). 계속할까요?",
  ...
  extensions: {
    ...
    mcp: {
      ...
      commandHintNpx: "PATH, 공식 Node 설치, fnm, nvm, Volta의 Node.js를 사용합니다.",
      commandHintUvx: "PATH 또는 기본 설치 위치의 uv를 사용합니다.",
      launcherCustom: "사용자 지정",
      commandPath: "실행 파일",
      commandPlaceholder: "npx 또는 절대 경로",
      args: "인수",
