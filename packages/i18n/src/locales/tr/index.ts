...
export const tr = {
  ...
  chat: {
    ...
    transcribe: "Sesi yazıya dök",
    transcribing: "Yazıya dökülüyor…",
    transcribeFailed: "Bu ses yazıya dökülemedi",
    speak: "Sesli oku",
    speaking: "Okunuyor…",
    speakFailed: "Bu taslak okunamadı",
    ...
    rewrittenByPlugin: "{{name}} tarafından yeniden yazıldı",
    rewriteModelVersion: "Modelin aldığı metin",
    rewritePartial: "Kayıt kısaltıldı, değişikliğin bir kısmı gösterilmiyor.",
...
sklm: {
    ...
    remoteHosts: {
      ...
      overview:
        "Bu masaüstünden yönetebileceğiniz eşleşmiş pi-host makineler. Eşleşmiş bir ana bilgisayardaki oturumlar yerel gibi görünür; bağlantı ana süreç içinde kalır ve hiçbir cihaz belirteci bu sayfaya ulaşmaz.",
      listTitle: "Eşleşmiş uzak ana bilgisayarlar",
      listError: "Ana bilgisayarlar yüklenemedi",
      loading: "Yükleniyor…",
      emptyTitle: "Henüz eşleşmiş ana bilgisayar yok",
      emptyBody: "Aşağıdan bir makineyi eşleştirerek üzerinde oturum başlatın.",
      statusOnline: "Çevrimiçi",
      statusOffline: "Çevrimdışı",
      remove: "Kaldır",
      removing: "Kaldırılıyor…",
      removed: "{{label}} kaldırıldı.",
      removeFailed: "Kaldırma başarısız: {{message}}",
      pairTitle: "Yeni ana bilgisayar eşle",
      pair: "Eşle",
      pairing: "Eşleşiyor…",
      pairAction: "Ekle",
      ...
      fieldLabel: "Etiket",
      fieldLabelDesc: "Listede görünür ve eşleşmiş ana bilgisayara kaydedilir.",
      fieldLabelPlaceholder: "Evdeki Linux",
      fieldUrl: "RACP URL",
      fieldUrlDesc:
        "pi-host geri döngü uç noktası, örn. ws://127.0.0.1:9443/racp (SSH üzerinden yönlendirilir).",
      fieldPairingToken: "Eşleşme belirteci",
      fieldPairingTokenDesc:
        "pi-host önyükleme çıktısından tek kullanımlık ppt1.* belirteci. Eşleşme sırasında tüketilir.",
    },
    ...
    speechTitle: "Ses",
    speechDesc: "Yazıya dökme ve konuşma yapılandırılmış bir sağlayıcı kullanır. Sohbet model listesinde görünmezler.",
    speechTranscribe: "Yazıya dökme",
    speechTranscribeDesc: "Ekli sesi taslak metne çevir.",
    speechSynthesize: "Konuşma",
    speechSynthesizeDesc: "Besteci taslağını sesli oku.",
    speechProvider: "Sağlayıcı",
    speechProtocol: "Protokol",
    speechModel: "Model",
    speechVoice: "Ses",
    speechNone: "Yapılandırılmadı",
    speechModelPlaceholder: "whisper-1",
    speechVoicePlaceholder: "alloy",
