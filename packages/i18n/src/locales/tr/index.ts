...
export const tr = {
  ...
  nav: {
    ...
    batchArchive: "{{count}} oturumu arşivle",
    batchDelete: "{{count}} oturumu sil",
    batchDeleteConfirm: "{{count}} oturum silinsin mi?",
  ...
  chat: {
    ...
    sendNowPending: "Geçerli görevin bitmesi bekleniyor",
    queuedPromptStopFailed: "Geçerli görev durdurulamadı. Bu mesaj hâlâ kuyrukta ve iptal edilebilir.",
    queuedPromptAlreadyStarted: "Bu mesaj zaten çalıştırılıyor. Çalışan görevi durdurmak için Durdur düğmesini kullanın.",
  ...
  settings: {
    ...
    "downloadGeneratedImage": "İndir",
    "revealGeneratedImage": "Klasörde göster",
    "imageRevealFailed": "Görsel klasörde gösterilemedi.",
...
sklm: {
    ...
    voiceChineseVariant: "Çince varyantı",
    voiceSimplified: "Basitleştirilmiş",
    voiceTraditionalTaiwan: "Geleneksel (Tayvan)",
    voiceTraditionalHK: "Geleneksel (Hong Kong)",
    voiceModel: "Transkripsiyon modeli",
    voiceModelDownload: "İndir",
    voiceModelDelete: "Sil",
    voiceModelDownloaded: "İndirildi",
    voiceModelDownloading: "İndiriliyor…",
    voiceModelNotDownloaded: "İndirilmedi",
    voiceModelSize: "{{size}}",
    voiceShortcut: "Kısayol",
    voiceLocalModels: "Yerel modeller",
    voiceNoModelSelected: "Model seçilmedi",
    voiceSelectModel: "Başlamak için bir model seçin",
    voiceMicDenied: "Mikrofon erişimi reddedildi",
    voiceMicDeniedDesc: "Sistem ayarlarından mikrofon erişimi verin.",
    voiceMicUnavailable: "Mikrofon kullanılamıyor",
    voiceOpenSystemSettings: "Sistem ayarlarını aç",
    voiceRecording: "Kaydediliyor…",
    voiceTranscribing: "Transkripsiyon…",
    voiceCancel: "İptal",
    shortcutGroup: {
      navigation: "Gezinme",
      agent: "Ajan",
    ...
    endpointFormatGuidance: "Bu istek URL’si {{format}} biçimini gösteriyor. Eşleşen biçimi ve temel adresi uygulayın; bu, bağlantıyı veya arama yeteneğini test etmez.",
    applyEndpointFormat: "Önerilen biçimi uygula",
    ...
    nativeWebSearchUnsupported: "Bu bağlantı için yerel arama henüz uygulamaya entegre edilmedi. Web sitesi veya başka bir API aramayı destekleyebilir.",
    ...
    midAutumnEgg: "Sonbahar Ortası sürprizi",
    midAutumnEggDesc: "Uygulama açıldığında bir kez oynatılan tam ekran Sonbahar Ortası (Ay Festivali) animasyonu; buradan yeniden oynatabilirsiniz.",
    playMidAutumnEgg: "Oynat",
    closeEasterEgg: "Kapat",
  ...
  plugins: {
    ...
    piSkillsTitle: "pi CLI becerileri",
    piSkillsHint: "Yüklü npm paketleri salt okunur olarak keşfedilir. Yalnızca güvendiğiniz paketleri içe aktarın; sonra Eklentiler bölümünden yönetin.",
    piSkillsConfirm: "Bu pi paketi içe aktarılsın ve etkinleştirilsin mi?",
    piSkillsExecutable: "Bu paket çalıştırılabilir uzantılar içerir. İçe aktarma, ajanda güvenilir kodu etkinleştirir ve bağımlılıkları yükleyebilir.",
    piSkillsPromptOnly: "Bu paket ajana yönergeler ekler. Kaynaklar kopyalanır ve bildirilen bağımlılıklar yüklenebilir.",
    piSkillsImport: "İçe aktar ve etkinleştir",
    piSkillsImported: "Zaten içe aktarıldı",
    piSkillsRefresh: "pi CLI becerilerini yenile",
    piSkillsEmpty: "pi CLI npm beceri paketi bulunamadı.",
    piSkillsLoading: "pi CLI becerileri aranıyor…",
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
  ...
  extensions: {
    ...
    mcp: {
      ...
      commandHintNpx: "PATH, resmi Node kurulumu, fnm, nvm veya Volta üzerindeki Node.js’i kullanır.",
      commandHintUvx: "PATH veya varsayılan kurulum konumundaki uv’yi kullanır.",
      launcherCustom: "Özel",
      commandPath: "Yürütülebilir",
      commandPlaceholder: "npx veya mutlak bir yol",
      args: "Argümanlar",
