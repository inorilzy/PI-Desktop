...
export const zhTW = {
  ...
  chat: {
    ...
    transcribe: "轉寫音訊",
    transcribing: "轉寫中…",
    transcribeFailed: "無法轉寫這段音訊",
    speak: "朗讀",
    speaking: "朗讀中…",
    speakFailed: "無法朗讀這段草稿",
    ...
    rewrittenByPlugin: "已由 {{name}} 改寫",
    rewriteModelVersion: "模型實際收到的內容",
    rewritePartial: "記錄已截斷，部分改動未顯示。",
...
sklm: {
    ...
    remoteHosts: {
      title: "遠端主機",
      overview:
        "已配對的 pi-host 機器；桌面能像本地一樣驅動其上的工作階段，連線留在主行程內，裝置權杖不會到達此頁面。",
      listTitle: "已配對的遠端主機",
      listError: "載入主機清單失敗",
      loading: "載入中…",
      emptyTitle: "尚未配對主機",
      emptyBody: "於下方配對一台機器以開始遠端工作階段。",
      statusOnline: "在線",
      statusOffline: "離線",
      remove: "移除",
      removing: "移除中…",
      ...
      fieldLabel: "標籤",
      fieldLabelDesc: "顯示於清單，並記錄到已配對主機上。",
      fieldLabelPlaceholder: "家裡的 Linux",
      fieldUrl: "RACP 位址",
      fieldUrlDesc:
        "pi-host 的迴環端點，例如 ws://127.0.0.1:9443/racp（經 SSH 轉發）。",
      fieldPairingToken: "配對權杖",
      fieldPairingTokenDesc:
        "來自 pi-host 引導輸出的一次性 ppt1.* 權杖，配對後即消耗。",
    },
    importTitle: "從其他工具匯入",
    importScan: "掃描",
    importScanning: "正在掃描…",
    ...
    thinkingDisplayModeDesc: "詳細模式顯示思考文字；精簡模式僅在思考時顯示狀態提示，結束後隱藏思考區塊。",
    ...
    defaultsTitle: "預設項",
    speechTitle: "語音",
    speechDesc: "轉寫和朗讀使用已設定的服務，不會出現在聊天模型清單裡。",
    speechTranscribe: "轉寫",
    speechTranscribeDesc: "把附件音訊轉成草稿文字。",
    speechSynthesize: "朗讀",
    speechSynthesizeDesc: "朗讀輸入框裡的草稿。",
    speechProvider: "服務",
    speechProtocol: "協定",
    speechModel: "模型",
    speechVoice: "音色",
  ...
  plugins: {
    ...
    rendererModuleTitle: "渲染器模組",
    rendererModuleLoaded: "已載入 —— 其槽位已生效。",
    rendererModuleNotLoaded:
      "尚未載入 —— 它的某個槽位第一次繪製時才會載入。",
    servicesTitle: "服務",
