...
export const zhTW = {
  ...
  nav: {
    ...
    batchArchive: "封存 {{count}} 個對話",
    batchDelete: "刪除 {{count}} 個對話",
    batchDeleteConfirm: "確認刪除 {{count}} 個對話？",
  ...
  chat: {
    ...
    sendNow: "立即傳送",
    sendNowPending: "等待目前任務結束",
    queuedPromptStopFailed: "無法停止目前任務。這則訊息仍在排隊，可以取消。",
    queuedPromptAlreadyStarted: "這則訊息已經開始執行，請使用停止按鈕。",
  ...
  settings: {
    ...
    downloadGeneratedImage: "下載",
    revealGeneratedImage: "在資料夾中顯示",
    imageRevealFailed: "無法在資料夾中顯示圖片。",
...
sklm: {
    ...
    voice: "語音",
    voiceEnable: "啟用語音輸入",
    voiceExperimental: "實驗性",
    voiceMicrophone: "麥克風",
    voiceSystemDefault: "系統預設",
    voiceLanguages: "語言",
    voiceChineseVariant: "中文變體",
    voiceSimplified: "簡體",
    voiceTraditionalTaiwan: "繁體（台灣）",
    voiceTraditionalHK: "繁體（香港）",
    voiceModel: "轉寫模型",
    voiceModelDownload: "下載",
    voiceModelDelete: "刪除",
    voiceModelDownloaded: "已下載",
    voiceModelDownloading: "下載中…",
    voiceModelNotDownloaded: "未下載",
    voiceModelSize: "{{size}}",
    voiceShortcut: "快捷鍵",
    voiceLocalModels: "本機模型",
    voiceNoModelSelected: "未選擇模型",
    voiceSelectModel: "請選擇模型以開始使用",
    voiceMicDenied: "麥克風權限被拒絕",
    voiceMicDeniedDesc: "請在系統設定中授予麥克風存取權限。",
    voiceMicUnavailable: "麥克風不可用",
    voiceOpenSystemSettings: "開啟系統設定",
    voiceRecording: "正在錄音…",
    ...
    endpointFormatGuidance: "此請求位址對應 {{format}}。可套用相符的介面格式和基礎位址；這不代表連線或搜尋能力已驗證。",
    applyEndpointFormat: "套用建議格式",
    ...
    nativeWebSearchUnsupported: "應用程式尚未整合此連線的原生搜尋；不代表廠商官網或其他 API 不支援搜尋。",
    ...
    easterEggs: "彩蛋",
    midAutumnEgg: "中秋彩蛋",
    midAutumnEggDesc: "應用程式啟動時播放一次的全螢幕中秋動畫，可在此再次播放。",
    playMidAutumnEgg: "再播一次",
    closeEasterEgg: "關閉",
    developer: "開發者",
    developerMode: "開發者模式",
  ...
  plugins: {
    ...
    loadDev: "載入本地外掛",
    loadDevDone: "本地外掛已載入",
    piSkillsTitle: "pi CLI 技能",
    piSkillsHint: "唯讀探索已安裝的 npm 套件。請僅匯入可信來源；匯入後在外掛頁管理。",
    piSkillsConfirm: "匯入並啟用此 pi 套件？",
    piSkillsExecutable: "此套件包含可執行擴充功能。匯入會在 Agent 中啟用可信程式碼，並可能安裝相依套件。",
    piSkillsPromptOnly: "此套件會向 Agent 新增指令。資源將被複製，並可能安裝宣告的相依套件。",
    piSkillsImport: "匯入並啟用",
    piSkillsImported: "已匯入",
  ...
  extensions: {
    ...
    mcp: {
      ...
      commandHintNpx: "自動尋找本機 Node.js，包括 PATH、官方安裝、fnm、nvm。",
      commandHintUvx: "自動尋找本機的 uv。",
      launcherCustom: "自訂",
      commandPath: "執行檔",
      commandPlaceholder: "npx 或絕對路徑",
      args: "引數",
