...
export const fr = {
  ...
  "chat": {
    ...
    "transcribeFailed": "Impossible de transcrire cet audio",
    "speak": "Lire à voix haute",
    "speaking": "Lecture…",
    "speakFailed": "Impossible de lire ce brouillon",
...
sklm: {
    ...
    "speechTitle": "Voix",
    "speechDesc": "La transcription et la synthèse utilisent un fournisseur configuré. Elles n’apparaissent pas dans le sélecteur de modèles du chat.",
    "speechTranscribe": "Transcription",
    "speechTranscribeDesc": "Transformer l’audio joint en texte du brouillon.",
    "speechSynthesize": "Synthèse",
    "speechSynthesizeDesc": "Lire le brouillon du compositeur à voix haute.",
    "speechProvider": "Fournisseur",
    "speechProtocol": "Protocole",
    "speechModel": "Modèle",
    "speechVoice": "Voix",
    "speechNone": "Non configuré",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
     ...
     */
    declaration: {
      title: "Ce que déclare ce plug-in",
      dataLabel: "Données qu'il lit",
      actionsLabel: "Actions qu'il appelle",
      data: {
        entry: "Entrées de la transcription",
        session: "Informations de session",
        code: "Blocs de code",
        theme: "Thème actuel",
        selection: "Texte sélectionné",
        draft: "Brouillon du composeur",
      ...
      actions: {
        ...
        "ui.closeOverlay": "Fermer la surcouche",
        "ui.openModal": "Ouvrir une boîte de dialogue",
        "ui.closeModal": "Fermer la boîte de dialogue",
        "ui.toast": "Afficher une notification",
      },
    },
    "permissions": {
