...
export const fr = {
  ...
  "chat": {
    ...
    "sessionReferenceChanged": "The target chat, model, or running turn changed while loading references. Your draft was not sent; try again.",
    "sessionReferenceBudgetBlocked": "The newest complete turns do not fit the reference budget. Increase Session reference budget in Settings > AI, free context, or use fewer references. Your draft was not sent.",
    "sessionReferenceIncomplete": "A complete newest turn could not be read within the reference limits. Increase Session reference budget in Settings > AI or use fewer references, then retry. Your draft was not sent.",
    "sessionReferenceSummary": "References: {{turns}} complete turns, approximately {{tokens}} tokens.",
    "sessionReferenceOmitted": "{{turns}} known older turns omitted.",
    "sessionReferenceUnread": "More history was not read; the total number of omitted turns is unknown.",
    ...
    "annotationSelectedText": "Texte sélectionné :",
    "annotationComment": "Commentaire de l'utilisateur :",
    "annotationCommentTitle": "Commentaire",
    "annotationCommentPlaceholder": "Ajouter un commentaire",
    "annotationEdit": "Modifier le commentaire",
    "annotationRemove": "Supprimer l'annotation",
    "annotationReview": "Examiner les annotations",
    "annotationLocate": "Localiser l’annotation",
    "annotationRowLocation": "Texte original indisponible ; affichage de la réponse source",
...
sklm: {
    ...
    "sessionReferenceBudget": "Session reference budget",
    "sessionReferenceBudgetDesc": "All referenced chats share this estimated budget from available model context. Include the newest complete turns; omit excess history with a notice, without a fixed turn limit. Token estimates are approximate; runtime context limits still apply.",
    "sessionReferenceBudgetOption": "{{percent}}% of available context",
    "sessionReferenceBudgetDefault": "{{percent}}% of available context (default)",
