...
export const fr = {
  ...
  "nav": {
    ...
    batchArchive: "Archiver {{count}} sessions",
...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
    ...
    sendNowPending: "En attente de la fin de la tâche en cours",
    queuedPromptStopFailed: "Impossible d’arrêter la tâche en cours. Ce message reste en attente et peut être annulé.",
    queuedPromptAlreadyStarted: "Ce message est déjà en cours d’exécution. Utilisez Arrêter pour arrêter la tâche.",
  ...
  "settings": {
    ...
    "downloadGeneratedImage": "Télécharger",
    "revealGeneratedImage": "Afficher dans le dossier",
    "imageRevealFailed": "Impossible d’afficher l’image dans son dossier.",
...
sklm: {
    ...
    "voiceChineseVariant": "Variante chinoise",
    "voiceSimplified": "Simplifié",
    "voiceTraditionalTaiwan": "Traditionnel (Taïwan)",
    "voiceTraditionalHK": "Traditionnel (Hong Kong)",
    "voiceModel": "Modèle de transcription",
    "voiceModelDownload": "Télécharger",
    "voiceModelDelete": "Supprimer",
    "voiceModelDownloaded": "Téléchargé",
    "voiceModelDownloading": "Téléchargement…",
    "voiceModelNotDownloaded": "Non téléchargé",
    "voiceModelSize": "{{size}}",
    "voiceShortcut": "Raccourci",
    "voiceLocalModels": "Modèles locaux",
    "voiceNoModelSelected": "Aucun modèle sélectionné",
    "voiceSelectModel": "Sélectionnez un modèle pour commencer",
    "voiceMicDenied": "Accès au microphone refusé",
    "voiceMicDeniedDesc": "Accordez l'accès au microphone dans les paramètres système.",
    "voiceMicUnavailable": "Microphone non disponible",
    "voiceOpenSystemSettings": "Ouvrir les paramètres système",
    ...
    nativeWebSearchUnsupported: "La recherche native n’est pas encore intégrée pour cette connexion. Le site web ou une autre API peut la proposer.",
    ...
    "midAutumnEgg": "Œuf de la Fête de la mi-automne",
    "midAutumnEggDesc": "Une animation en plein écran de la Fête de la mi-automne qui se joue une fois à l'ouverture de l'application ; vous pouvez la relancer ici.",
    "playMidAutumnEgg": "Lire",
    "closeEasterEgg": "Fermer",
