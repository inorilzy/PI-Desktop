export const en = {
  ...
  nav: {
    ...
    batchArchive: "Archive {{count}} sessions",
    batchDelete: "Delete {{count}} sessions",
    batchDeleteConfirm: "Delete {{count}} sessions?",
  ...
  chat: {
    ...
    sendNow: "Send now",
    sendNowPending: "Waiting for the current task to finish",
    queuedPromptStopFailed: "Could not stop the current task. This message is still queued and can be canceled.",
    queuedPromptAlreadyStarted: "This message has already started. Use Stop to stop the running task.",
  ...
  settings: {
    ...
    downloadGeneratedImage: "Download",
    revealGeneratedImage: "Show in folder",
    imageRevealFailed: "Could not show the image in its folder.",
...
sklm: {
    ...
    voiceChineseVariant: "Chinese variant",
    voiceSimplified: "Simplified",
    voiceTraditionalTaiwan: "Traditional (Taiwan)",
    voiceTraditionalHK: "Traditional (Hong Kong)",
    voiceModel: "Transcription model",
    voiceModelDownload: "Download",
    voiceModelDelete: "Delete",
    voiceModelDownloaded: "Downloaded",
    voiceModelDownloading: "Downloading…",
    voiceModelNotDownloaded: "Not downloaded",
    voiceModelSize: "{{size}}",
    voiceShortcut: "Shortcut",
    voiceLocalModels: "Local models",
    voiceNoModelSelected: "No model selected",
    voiceSelectModel: "Select a model to get started",
    voiceMicDenied: "Microphone access denied",
    voiceMicDeniedDesc: "Grant microphone access in System Settings.",
    voiceMicUnavailable: "Microphone unavailable",
    voiceOpenSystemSettings: "Open System Settings",
    ...
    nativeWebSearchUnsupported: "This app has not integrated native search for this connection. Website search or another API may still be available.",
    ...
    midAutumnEgg: "Mid-Autumn egg",
    midAutumnEggDesc: "A full-screen Moon Festival animation that plays once when the app opens; replay it here.",
    playMidAutumnEgg: "Play",
    closeEasterEgg: "Close",
    developer: "Developer",
  ...
  plugins: {
    ...
    piSkillsTitle: "Skills from pi CLI",
    piSkillsHint: "Installed npm packages are discovered read-only. Import only packages you trust; manage imported packages in Plugins.",
    piSkillsConfirm: "Import and enable this pi package?",
    piSkillsExecutable: "This package includes executable extensions. Importing enables trusted code in the agent runtime and may install dependencies.",
    piSkillsPromptOnly: "This package adds instructions to the agent. Its resources will be copied; declared dependencies may be installed.",
    piSkillsImport: "Import and enable",
    piSkillsImported: "Already imported",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  extensions: {
    ...
    mcp: {
      ...
      commandHintNpx: "Uses Node.js from PATH, fnm, nvm, or Volta. Official Node installs work the same way.",
      commandHintUvx: "Uses uv from PATH or the default uv install location.",
      launcherCustom: "Custom",
      commandPath: "Executable",
      commandPlaceholder: "npx or an absolute path",
      args: "Arguments",
