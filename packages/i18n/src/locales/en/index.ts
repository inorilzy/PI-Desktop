export const en = {
  ...
  chat: {
    ...
    placeholderHint: "Type / for commands · @ for files and sessions",
    placeholderHomeHint: "Type / for commands · @ for files and sessions",
    ...
    fileEmpty: "No matching files or sessions",
    ...
    annotationCommentTitle: "Comment",
    annotationCommentPlaceholder: "Add a comment",
  ...
  sideChat: {
    ...
    empty: "Ask here to keep the main conversation unchanged.",
    addToMain: "Add to main chat",
