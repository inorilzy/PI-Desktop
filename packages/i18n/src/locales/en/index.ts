export const en = {
  ...
  chat: {
    ...
    transcribeFailed: "Couldn't transcribe this audio",
    speak: "Read aloud",
    speaking: "Reading…",
    speakFailed: "Couldn't read this draft",
...
sklm: {
    ...
    speechTitle: "Voice",
    speechDesc: "Transcription and speech use a configured provider. They stay out of the chat model picker.",
    speechTranscribe: "Transcription",
    speechTranscribeDesc: "Turn attached audio into draft text.",
    speechSynthesize: "Speech",
    speechSynthesizeDesc: "Read the composer draft aloud.",
    speechProvider: "Provider",
    speechProtocol: "Protocol",
    speechModel: "Model",
    speechVoice: "Voice",
    speechNone: "Not configured",
